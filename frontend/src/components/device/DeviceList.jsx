        ...
        devices.map((device) => (
          ...
          >
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-semibold border ${
                    device.status === "online"
                      ? "bg-green-200 text-green-800 border-green-300 shadow-[0_0_10px_rgba(74,222,128,0.3)]" // Online: Nền xanh, chữ xanh, viền xanh + Hiệu ứng phát sáng nhẹ
                      : "bg-gray-100 text-gray-500 border-gray-200" // Offline: Xám
                  }`}
                >
            ...
            <div className="flex items-center gap-2 mt-3 pt-3 border-t border-gray-200">
              ...
              >
                <Trash2 size={16} />
                {deletingId === device.id ? "Đang xử lý..." : "Gỡ bỏ"}
              </button>
            </div>

            {device.sos && (
              <div className="flex items-center gap-2 px-3 py-2 bg-red-500 text-white rounded-lg text-sm font-semibold mt-3">
                <AlertCircle size={16} />
            ...
            {device.geofence === "OUTSIDE" && !device.sos && (
              <div className="flex items-center gap-2 px-3 py-2 bg-orange-500 text-white rounded-lg text-sm font-semibold mt-3">
                <AlertCircle size={16} />
